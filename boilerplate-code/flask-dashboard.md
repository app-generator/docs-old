...
$ # Get the code
$ git clone https://github.com/app-generator/boilerplate-code-flask-dashboard.git
$ cd app-generator/boilerplate-code-flask-dashboard
```
...
- Download a few sample projects built on top of this codebase: 
  - [Datta Able Flask](https://appseed.us/product/datta-able/flask/) - open-source `Bootstrap 5` Design
  - [Flask Bootstrap 5 Volt](https://appseed.us/product/volt-dashboard/flask/) - open-source starter
  - [Flask Soft UI Dashboard](https://appseed.us/product/soft-ui-dashboard/flask/) - free `Bootstrap 5` starter 
