...
![Django Template Volt - Free Admin Theme ](<../../.gitbook/assets/image (13).png>)
...
> The name respects the convention ` APP_NAME.apps.APP_NAMEConfig` required by all apps defined in the  **INSTALLED_APPS **section.
...
![Django Template Volt - Edit Users Page](<../../.gitbook/assets/image (12).png>)
