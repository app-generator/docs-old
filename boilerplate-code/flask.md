...
#### Route `/login.html` <a href="#route-loginhtml" id="route-loginhtml"></a>
...
#### Route `/register.html` <a href="#route-registerhtml" id="route-registerhtml"></a>
...
#### Route `/logout.html` <a href="#route-logouthtml" id="route-logouthtml"></a>

The route delete the user session and redirect the user to the `login.html`

#### Default Route `/` <a href="#default-route" id="default-route"></a>
