...
Flask Admin Dashboard generated by the AppSeed platform on top of [Datta Able PRO](https://appseed.us/product/datta-able-pro/) design (Premium version) crafted by `CodedThemes`.

> Version: [**v1.0.7**](https://github.com/app-generator/flask-datta-able-pro/releases) - release date `2022-05-30`
...
* `Improved Authentication`
  * Users are suspended after `N` failed logins
  * Password Strength Check (during registration)
* `Extended User Profile`
  * ordinary users are able to edit their profile information
  * Admins can edit all users and also suspend
* `User Roles`:
  * Users: basic profile
  * Admin: can view, edit, delete and suspend all users
* `Improved CLI`:
...
* 👉 [Datta Able PRO Flask](https://flask-datta-able-enh.appseed-srv1.com/) - LIVE deployment
