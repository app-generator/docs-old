---
description: >-
  Open-source Flask Starter coded on top Material Dashboard design (Free
  Version).
---
...
As explained in the [Static Assets](material-dashboard.md#static-assets) section, the assets are managed via:
