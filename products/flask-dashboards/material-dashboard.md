---
description: Open-source Flask Starter coded on top Material Dashboard design (Free Version).
---

# [Material Dashboard Flask](https://appseed.us/product/material-dashboard/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of **Material Dashboard** Design (free version) crafted by `Creative-Tim`.

> Version: **[v1.0.7](https://github.com/app-generator/flask-material-dashboard/releases)** - release date `2022-06-09` 
...
- 👉 [Material Dashboard Flask](https://appseed.us/product/material-dashboard/flask/) - Product page
- 👉 [Material Dashboard Flask](https://flask-material-dashboard.appseed-srv1.com/) - LIVE deployment
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/material-dashboard-assets`, the `.env` file should be updated as below: 

```.env
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/material-dashboard-assets
```
 
## 🚀 Where to go from here

- 👉 Access the [support](https://appseed.us/support/) page in case something is missing
- 👉 Use [Material Dashboard Generator](https://appseed.us/generator/material-dashboard/) to generate a new project
- 👉 Check-out the PREMIUM version, [Flask Material Dashboard PRO](https://flask-material-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ More pages & components
  - ✅ Priority on support 
  - ✅ [Flask Material Dashboard PRO](https://appseed.us/product/material-dashboard-pro/flask/) - `product page`
