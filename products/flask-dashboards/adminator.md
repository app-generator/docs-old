...
Flask Admin Dashboard generated by the AppSeed platform on top of [Adminator](https://appseed.us/product/adminator/flask/), an iconic free dahsboard template.
...
As explained in the [Static Assets](adminator.md#static-assets) section, the assets are managed via:
