---
description: Open-source Flask Starter coded on top Azia Dashboard design (free version).
---
...
> Version: [**v1.0.5**](https://github.com/app-generator/flask-azia-dashboard/releases) - release date `2022-06-10`

* Built with [Azia Generator](https://appseed.us/generator/azia-dashboard/)
...
As explained in the [Static Assets](azia-dashboard.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/azia-admin-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/azia-admin-assets
```

## 🚀 Where to go from here

* 👉 Access the [support](https://appseed.us/support/) page in case something is missing
* 👉 Use [Azia Generator](https://appseed.us/generator/azia-dashboard/) to generate a new project
* 👉 Check-out the PREMIUM version, [Flask Azia PRO](https://flask-azia-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ More pages & components
  * ✅ Priority on support
  * ✅ [Flask Azia PRO](https://appseed.us/product/azia-dashboard-pro/flask/) - `product page`
