---
description: Open-source Flask Starter coded on top Atlantis Dark design (free version).
---

# [Atlantis Dark Flask](https://appseed.us/product/atlantis-dark/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of Atlantis Dark design (free version) crafted by `ThemeKita`.


> Version: [**v1.0.6**](https://github.com/app-generator/flask-atlantis-dark/releases) - release date `2022-06-09`
...
As explained in the [Static Assets](atlantis-dark.md#static-assets) section, the assets are managed via:
...
* 👉 Use [Atlantis Dark Generator](https://appseed.us/generator/atlantis-dark/) to generate a new project
* 👉 Check-out the PREMIUM version, [Atlantis Dark PRO Flask](https://flask-atlantis-dark-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
