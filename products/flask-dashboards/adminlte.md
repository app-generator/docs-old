---
description: Open-source Flask Starter coded on top AdminLTE design.
---

# [AdminLTE Flask](https://appseed.us/product/adminlte/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of [AdminLTE](https://appseed.us/product/adminlte/), an iconic free dahsboard template.

> Version: **[v1.0.8](https://github.com/app-generator/flask-adminlte/releases)** - release date `2022-05-30` 
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/adminlte-assets`, the `.env` file should be updated as below: 

```.env
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/adminlte-assets
```
 
## 🚀 Where to go from here

- 👉 Access the [support](https://appseed.us/support/) page in case something is missing
- 👉 Use [AdminLTE Generator](https://appseed.us/generator/adminlte/) to generate a new project
- 👉 Check-out the PREMIUM version, [Flask AdminLTE PRO](https://flask-datta-able-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ `Bootstrap 5` version
  - ✅ More pages & components
  - ✅ `Dark-Mode` 
  - ✅ Priority on support 
  - ✅ [Flask AdminLTE PRO](https://appseed.us/product/datta-able-pro/flask/) - `product page`
