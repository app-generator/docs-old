---
description: Open-source Flask Starter coded on top Volt Bootstrap 5 design (Free Version).
---

# [Volt Dashboard Flask](https://appseed.us/product/volt-dashboard/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of [Volt Dashboard](https://appseed.us/product/volt-dashboard/) design (free version) crafted by `Themesberg`.

> Version: **[v1.0.7](https://github.com/app-generator/flask-volt-dashboard/releases)** - release date `2022-05-24` 
...
- 👉 Check-out the PREMIUM version, [Flask Volt PRO](https://flask-volt-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ `Bootstrap 5` version
