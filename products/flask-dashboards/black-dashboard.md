...
Flask Admin Dashboard generated by the AppSeed platform on top of [Black Dashboard](https://appseed.us/product/black-dashboard/) design (free version) crafted by `Creative-Tim`.


> Version: [**v1.0.8**](https://github.com/app-generator/flask-black-dashboard/releases) - release date `2022-05-30`

* Built with [Black Dashboard Generator](https://appseed.us/generator/black-dashboard/)
* UI Kit: [Black Dashboard](https://appseed.us/product/black-dashboard/) (free version)
...
* 👉 [Black Dashboard Flask](https://flask-black-dashboard.appseed-srv1.com/) - LIVE deployment
...
As explained in the [Static Assets](black-dashboard.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/black-dashboard-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/black-dashboard-assets
```

## 🚀 Where to go from here

* 👉 Access the [support](https://appseed.us/support/) page in case something is missing
* 👉 Use [Black Dashboard Generator](https://appseed.us/generator/black-dashboard/) to generate a new project
* 👉 Check-out the PREMIUM version, [Flask Black Dashboard PRO](https://flask-black-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ More pages & components
  * ✅ `Dark-Mode`
  * ✅ Priority on support
  * ✅ [Flask Black Dashboard PRO](https://appseed.us/product/black-dashboard-pro/flask/) - `product page`
