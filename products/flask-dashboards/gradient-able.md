---
description: Open-source Flask Starter coded on top Gradient Able design (Free Version).
---

# [Gradient Able Flask](https://appseed.us/product/gradient-able/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of [Gradient Able](https://appseed.us/product/gradient-able/) design (free version) crafted by `CodedThemes`.


> Version: [**v1.0.7**](https://github.com/app-generator/flask-gradient-able/releases) - release date `2022-05-30`
...
* 👉 Check-out the PREMIUM version, [Flask Gradient Able PRO](https://flask-gradient-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ More pages & components
  * ✅ `Dark-Mode`
  * ✅ Priority on support
  * ✅ [Flask Gradient Able PRO](https://appseed.us/product/gradient-able-pro/flask/) - `product page`
