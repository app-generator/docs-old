---
description: Open-source Flask Starter coded on top CoreUI design.
---

# [CoreUI Flask](https://appseed.us/product/coreui/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of [CoreUI](https://appseed.us/product/coreui/), an iconic free dahsboard template.


> Version: [**v1.0.7**](https://github.com/app-generator/flask-coreui/releases) - release date `2022-05-30`
...
As explained in the [Static Assets](coreui.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/coreui-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/coreui-assets
```

## 🚀 Where to go from here

* 👉 Access the [support](https://appseed.us/support/) page in case something is missing
* 👉 Use [CoreUI Generator](https://appseed.us/generator/coreui/) to generate a new project
