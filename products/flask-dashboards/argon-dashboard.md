---
description: Open-source Flask Starter coded on top Argon Dashboard design (Free Version).
---

# [Argon Dashboard Flask](https://appseed.us/product/argon-dashboard/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of **Argon Dashboard** Design (free version) crafted by `Creative-Tim`.


> Version: [**v1.0.6**](https://github.com/app-generator/flask-argon-dashboard/releases) - release date `2022-06-09`
...
* 👉 Check-out the PREMIUM version, [Flask Argon Dashboard PRO](https://flask-argon-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ More pages & components
  * ✅ Priority on support
  * ✅ [Flask Argon Dashboard PRO](https://appseed.us/product/argon-dashboard-pro/flask/) - `product page`
