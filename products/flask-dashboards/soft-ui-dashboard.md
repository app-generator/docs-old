---
description: >-
  Open-source Flask Starter coded on top Soft UI Dashboard design (Free
  Version).
---

# [Soft UI Dashboard Flask](https://appseed.us/product/soft-ui-dashboard/flask/)

Flask Admin Dashboard generated by the AppSeed platform on top of [Soft UI Dashboard](https://appseed.us/product/soft-ui-dashboard/) design (free version) crafted by `Creative-Tim`.


> Version: [**v1.0.6**](https://github.com/app-generator/flask-soft-ui-dashboard/releases) - release date `2022-05-24`
...
{% embed url="https://www.youtube.com/watch?v=5eOj-xlgIMM" %}
Flask Soft UI Dashboard - Open-Source Seed Project
{% endembed %}
...
* 👉 Check-out the PREMIUM version, [Soft UI Dashboard PRO](https://appseed.us/product/soft-ui-dashboard-pro/flask/) (`live demo`) for more features and improved UI
  * ✅ `Bootstrap 5` version
  * ✅ More pages & components
  * ✅ Priority on support
  * ✅ [Soft UI Dashboard PRO](https://appseed.us/product/soft-ui-dashboard-pro/flask/) - `product page`
