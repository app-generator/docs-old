---
description: Open-source Django Starter coded on top Volt Bootstrap 5 design (Free Version).
---

# [Volt Dashboard Django](https://appseed.us/product/volt-dashboard/django/)

Django Admin Dashboard generated by the AppSeed platform on top of [Volt Dashboard](https://appseed.us/product/volt-dashboard/) design (free version) crafted by `Themesberg`.

> Version: **[v1.0.7](https://github.com/app-generator/django-volt-dashboard/releases)** - release date `2022-05-24` 
...
- 👉 Use [Volt Dashboard Generator](https://appseed.us/generator/volt-dashboard/) to generate a new project
- 👉 Check-out the PREMIUM version, [Django Volt PRO](https://django-volt-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ `Bootstrap 5` version
  - ✅ More pages & components
  - ✅ Priority on support 
  - ✅ [Django Volt PRO](https://appseed.us/product/volt-dashboard-pro/django/) - `product page`

![Django Volt PRO - Premium Starter.](https://user-images.githubusercontent.com/51070104/167878207-37758fbf-fbea-4140-9232-d5bf0c6a1fe8.jpg)
