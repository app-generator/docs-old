---
description: >-
  Admin dashboard generated by AppSeed in Django on top of Soft Dashboard design (PRO version).
---

# [Soft UI Dashboard PRO Django](https://appseed.us/product/soft-ui-dashboard-pro/django/)

Django Admin Dashboard generated by the AppSeed platform on top of Soft UI Dashboard Design (Premium version) crafted by `Creative-Tim`.


> Version: **v1.0.4** - release date `2022-05-30`
...
{% embed url="https://www.youtube.com/watch?v=TaiG9AzLfj4" %}
Django Soft Dashboard PRO - Presentation
...
> 👉 **Step 1** - Access the [product page](https://appseed.us/product/soft-ui-dashboard-pro/django/) and download the ZIP (requires a purchase)
...
> Download the code - access the [product page](https://appseed.us/product/soft-ui-dashboard-pro/django/) and download the ZIP (requires a purchase)
...
As explained in the [Static Assets](soft-ui-dashboard-pro.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/soft-ui-dashboard-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/soft-ui-dashboard-assets
```
...
* 👉 Use [Soft Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/) to generate a new project
