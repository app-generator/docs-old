---
description: Open-source Django Starter coded on top Gradient Able design (free version).
---

# [Gradient Able Django](https://appseed.us/product/gradient-able/django/)

Django Admin Dashboard generated by the AppSeed platform on top of [Gradient Able](https://appseed.us/product/gradient-able/) design (free version) crafted by `CodedThemes`.

> Version: **[v1.0.5](https://github.com/app-generator/django-gradient-able/releases)** - release date `2022-05-30` 

* Built with [Gradient Able Generator](https://appseed.us/generator/gradient-able/)
* UI Kit: [Gradient Able](https://appseed.us/product/gradient-able/) (free version)
...
- 👉 Use [Gradient Able Generator](https://appseed.us/generator/gradient-able/) to generate a new project
- 👉 Check-out the PREMIUM version, [Django Gradient Able PRO](https://django-gradient-able-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ More pages & components
  - ✅ `Dark-Mode` 
  - ✅ `Dynamic API` feature
  - ✅ Priority on support 
  - ✅ [Django Gradient Able PRO](https://appseed.us/product/gradient-able-pro/django/) - `product page`
