---
description: Open-source Django Starter coded on top Atlantis Dark design (free version).
---
...
> Version: **[v1.0.5](https://github.com/app-generator/django-atlantis-dark/releases)** - release date `2022-06-09` 
...
- 👉 Check-out the PREMIUM version, [Atlantis Dark PRO Django](https://django-atlantis-dark-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
