---
description: Open-source Django Starter coded on top Material Dashboard Design (free version).
---

# [Material Dashboard Django](https://appseed.us/product/material-dashboard/django/)

Django Admin Dashboard generated by the AppSeed platform on top of **Material Dashboard** design (free version) crafted by `Creative-Tim`.

> Version: **[v1.0.5](https://github.com/app-generator/django-material-dashboard/releases)** - release date `2022-06-09` 
...
* 👉 [Material Dashboard Django](https://appseed.us/product/material-dashboard/django/) - product page
...
- 👉 Check-out the PREMIUM version, [Django Material Dashboard PRO](https://django-material-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ More pages & components
  - ✅ Priority on support 
  - ✅ [Django Material Dashboard PRO](https://appseed.us/product/material-dashboard-pro/django/) - `product page`
