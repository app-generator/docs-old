---
description: >-
  Open-source Django Starter coded on top Soft UI Dashboard Design (Free
  Version).
---

# [Soft UI Dashboard Django](https://appseed.us/product/soft-ui-dashboard/django/)

Django Admin Dashboard generated by the AppSeed platform on top of [Soft UI Dashboard](https://appseed.us/product/soft-ui-dashboard/) design (free version) crafted by `Creative-Tim`.


> Version: [**v1.0.7**](https://github.com/app-generator/django-soft-ui-dashboard/releases) - release date `2022-05-24`
...
{% embed url="https://www.youtube.com/watch?v=muHMZ16irXI" %}
Django Soft Dashboard - Open-Source Starter
{% endembed %}
...
As explained in the [Static Assets](soft-ui-dashboard.md#static-assets) section, the assets are managed via:
...
* 👉 Use [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/) to generate a new project
* 👉 Check-out the PREMIUM version, [Soft UI Dashboard PRO](https://appseed.us/product/soft-ui-dashboard-pro/django/) (`live demo`) for more features and improved UI
  * ✅ `Bootstrap 5` version
  * ✅ More pages & components
  * ✅ Priority on support
  * ✅ [Soft UI Dashboard PRO](https://appseed.us/product/soft-ui-dashboard-pro/django/) - `product page`
