...
* Bootstrap 5 Design (no jQuery dependency)
  - `Light/Dark Mode`
  - 190 pages: Charts, Dashboards, Layouts
...
> Download the code and unzip the code
...
The entry point of the project is the `core.settings.py` file where the project configuration is bundled. 
