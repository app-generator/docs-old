...
Django Admin Dashboard generated by the AppSeed platform on top of [Black Dashboard](https://appseed.us/product/black-dashboard/) design (free version) crafted by `Creative-Tim`.

> Version: [**v1.0.5**](https://github.com/app-generator/django-black-dashboard/releases) - release date `2022-05-30`

* Built with [App Generator](https://appseed.us/generator/black-dashboard/)
...
* 👉 Check-out the PREMIUM version, [Django Black Dashboard PRO](https://django-black-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ More pages & components
  * ✅ `Dark-Mode`
  * ✅ Priority on support
  * ✅ [Django Black Dashboard PRO](https://appseed.us/product/black-dashboard-pro/django/) - `product page`
