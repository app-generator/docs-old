---
description: >-
  Premium Starter Django coded on top Volt PRO Bootstrap 5 design (Premium
  Version).
---
...
As explained in the [Static Assets](volt-pro.md#static-assets) section, the assets are managed via:
