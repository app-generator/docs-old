---
description: Premium Starter Django coded on top Volt PRO Bootstrap 5 design (Premium Version).
---

# Volt Dashboard PRO Django

Django Admin Dashboard generated by the AppSeed platform on top of **Volt PRO Dashboard** Design (premium version) crafted by `Themesberg`.

> Version: **[v1.0.8](https://github.com/app-generator/django-volt-dashboard-pro/releases)** - release date `2022-06-13` 
...
```.env
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/volt-pro-assets
```
