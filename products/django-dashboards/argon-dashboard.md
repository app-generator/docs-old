---
description: Open-source Django Starter coded on top Argon Dashboard design (free version).
---

# [Argon Dashboard Django](https://appseed.us/product/argon-dashboard/django/)

Django Admin Dashboard generated by the AppSeed platform on top of **Argon Dashboard** design (free version) crafted by `Creative-Tim`.

> Version: **[v1.0.4](https://github.com/app-generator/django-argon-dashboard/releases)** - release date `2022-06-09` 
...
* 👉 [Argon Dashboard Django](https://appseed.us/product/argon-dashboard/django/) - product page
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/argon-dashboard-assets`, the `.env` file should be updated as below: 

```.env
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/argon-dashboard-assets
```
 
## 🚀 Where to go from here

- 👉 Access the [support](https://appseed.us/support/) page in case something is missing
- 👉 Use [Argon Dashboard Generator](https://appseed.us/generator/argon-dashboard/) to generate a new project
- 👉 Check-out the PREMIUM version, [Django Argon Dashboard PRO](https://django-argon-dashboard-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ More pages & components
  - ✅ Priority on support 
  - ✅ [Django Argon Dashboard PRO](https://appseed.us/product/argon-dashboard-pro/django/) - `product page`
