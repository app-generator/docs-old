---
description: Open-source Django Starter coded on top AdminLTE design.
---

# [AdminLTE Django](https://appseed.us/product/adminlte/django/)

Django Admin Dashboard generated by the AppSeed platform on top of **AdminLTE** design, an iconic free dahsboard template.

> Version: [**v1.0.6**](https://github.com/app-generator/django-adminlte/releases) - release date `2022-05-30`

* Built with [App Generator](https://appseed.us/generator/)
* UI Kit: `AdminLTE`, design `ColorLib`
...
As explained in the [Static Assets](adminlte.md#static-assets) section, the assets are managed via:
