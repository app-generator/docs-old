---
description: Flask Starter coded on top Soft UI Design PRO (Premium Version).
---

# [Soft UI Design PRO Flask](https://appseed.us/product/soft-ui-design-pro/flask/)

Flask Web App generated by the AppSeed platform on top of [Soft UI Design](https://appseed.us/product/soft-ui-design/) design (Premium version) crafted by `Creative-Tim`.
...
As explained in the [Static Assets](soft-ui-design-pro.md#static-assets) section, the assets are managed via:
