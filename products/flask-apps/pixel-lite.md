---
description: Open-source Flask Starter coded on top Pixel Lite Design (free version).
---

# Flask Pixel Lite

Flask Web App generated by the AppSeed platform on top of [Pixel Lite](https://appseed.us/product/pixel-bootstrap/) design (free version) crafted by `Themesberg`.

> Version: [**v1.0.8**](https://github.com/app-generator/flask-pixel/releases) - release date `2022-05-31`
...
* 👉 [Flask Pixel Lite](https://appseed.us/product/pixel-bootstrap/pixel/) - product page
* 👉 [Flask Pixel Lite](https://pixel-pixel-lite.appseed-srv1.com/) - LIVE Deployment
...
**Pixel Lite** is an extension of the Bootstrap 5 CSS framework with a focus on heavy styling customization but also with components that are not found by default in the framework, such as new cards, date pickers, timeline items, and the example pages
...
As explained in the [Static Assets](pixel-lite.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/pixel-lite-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/pixel-lite-assets
```

## 🚀 Where to go from here

* 👉 Access the [support](https://appseed.us/support/) page in case something is missing
* 👉 Use [Pixel Lite Generator](https://appseed.us/generator/pixel-bootstrap/) to generate a new project
* 👉 Check-out the PREMIUM version, [Flask Pixel PRO](https://flask-pixel-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ `Bootstrap 5` version
