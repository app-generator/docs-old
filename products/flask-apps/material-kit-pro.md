---
description: Premium Flask Starter coded on top Material Kit PRO Design (BS4 version).
---

# [Flask Material Kit PRO](https://appseed.us/product/material-kit-pro/flask/)

Flask Web App generated by the AppSeed platform on top of **Material Kit PRO** Design (BS4 version) crafted by `Creative-Tim`.


> Version: [**v1.0.2**](https://github.com/app-generator/flask-material-kit-pro/releases) - release date `2022-06-11`

* UI Kit: **Material Kit PRO** (BS4 version)
...
Designed for those who like bold elements and beautiful websites, **Material Kit PRO** is ready to help you create stunning websites and web apps.

**Material Kit PRO** is built with over 60 frontend individual elements, like buttons, inputs, navbars, nav tabs, cards, or alerts, giving you the freedom of choosing and combining. All components can take variations in color, which you can easily modify using SASS files and classes.

> UI Kit Documentation - full presentation over the [UI foundation](https://demos.creative-tim.com/material-kit-pro/docs/2.1/getting-started/introduction.html?AFFILIATE=128200) and [components](https://demos.creative-tim.com/material-kit-pro/docs/2.1/components/alerts.html?AFFILIATE=128200)
...
As explained in the [Static Assets](material-kit-pro.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/material-kit-pro-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/material-kit-pro-assets
```
