---
description: Open-source Flask Starter coded on top Soft UI Design (free version).
---

# [Flask Soft UI Design](https://appseed.us/product/soft-ui-design/flask/)

Flask Web App generated by the AppSeed platform on top of [Soft UI Design](https://appseed.us/product/soft-ui-design/) design (free version) crafted by `Creative-Tim`.

> Version: **[v1.0.6](https://github.com/app-generator/flask-soft-ui-design/releases)** - release date `2022-05-31` 
...
The entry point of the project is the `run.py` file where the project configuration is bundled. 
...
- 👉 Check-out the PREMIUM version, [Flask Soft Design PRO](https://flask-soft-ui-design-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ `Bootstrap 5` version
  - ✅ More pages & components
  - ✅ Priority on support 
  - ✅ [Flask Soft Design PRO](https://appseed.us/product/soft-ui-design-pro/flask/) - `product page`

![Flask Soft Design PRO - Starter generated by AppSeed.](https://user-images.githubusercontent.com/51070104/168812715-52e036b7-582d-4851-9657-6b1f99727619.png)