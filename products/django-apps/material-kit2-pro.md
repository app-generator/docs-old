---
description: Premium Django Starter coded on top Material Kit2 PRO Design (BS5 version).
---

# Django Material Kit 2 PRO

Django Web App generated by the AppSeed platform on top of **Material Kit2 PRO** Design (BS5 version) crafted by `Creative-Tim`.

> Version: [**v1.0.2**](https://github.com/app-generator/django-material-kit2-pro/releases) - release date `2022-06-12`
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/material-kit-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/material-kit-assets
```

## 🚀 Where to go from here

* 👉 Access the [support](https://appseed.us/support/) page in case something is missing
* 👉 Use [Material Kit Generator](https://appseed.us/generator/material-kit/) to generate a new project
