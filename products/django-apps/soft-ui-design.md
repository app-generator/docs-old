---
description: Open-source Django Starter coded on top Soft UI Design (free version).
---

# Django Soft Design

Django Web App generated by the AppSeed platform on top of [Soft UI Design](https://appseed.us/product/soft-ui-design/) design (free version) crafted by `Creative-Tim`.

> Version: [**v1.0.4**](https://github.com/app-generator/django-soft-ui-design/releases) - release date `2022-05-31`

* Built with [Soft UI Design Generator](https://appseed.us/generator/soft-ui-design/)
* UI Kit: [Soft UI Design](https://appseed.us/product/soft-ui-design/) (free version)
...
Soft UI Design System is built with over 70 frontend individual elements, like buttons, inputs, navbars, navtabs, cards or alerts, giving you the freedom of choosing and combining.

> UI Kit Documentation - full presentation over the [UI foundation](https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-design-system?AFFILIATE=128200) and [components](https://www.creative-tim.com/learning-lab/bootstrap/alerts/soft-ui-design-system?AFFILIATE=128200)
...
As explained in the [Static Assets](soft-ui-design.md#static-assets) section, the assets are managed via:
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/soft-ui-assets`, the `.env` file should be updated as below:

```
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/soft-ui-assets
```
...
* 👉 Check-out the PREMIUM version, [Django Soft Design PRO](https://django-soft-ui-design-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  * ✅ `Bootstrap 5` version
  * ✅ More pages & components
  * ✅ Priority on support
  * ✅ [Django Soft Design PRO](https://appseed.us/product/soft-ui-design-pro/django/) - `product page`

![Django Soft Design PRO - Starter generated by AppSeed.](https://user-images.githubusercontent.com/51070104/168812715-52e036b7-582d-4851-9657-6b1f99727619.png)
