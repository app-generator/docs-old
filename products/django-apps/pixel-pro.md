---
description: Django Starter coded on top Pixel PRO Design (Premium version).
---

# [Django Pixel PRO](https://appseed.us/product/pixel-bootstrap-pro/django/)

Django Web App generated by the AppSeed platform on top of **Pixel PRO** design (Premium version) crafted by `Themesberg`.

> Version: **[v1.0.4](https://github.com/app-generator/django-pixel-pro/releases)** - release date `2022-05-30` 
...
- 👉 [Django Pixel PRO](https://django-pixel-pro.appseed-srv1.com/) - LIVE Deployment
...
For instance, if the `static` files are copied to `https://cdn.your-server.com/pixel-pro-assets`, the `.env` file should be updated as below: 

```.env
# No Slash at the end
ASSETS_ROOT=https://cdn.your-server.com/pixel-pro-assets
```
