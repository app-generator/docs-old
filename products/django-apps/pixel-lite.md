---
description: Open-source Django Starter coded on top Pixel Lite Design (free version).
---

# [Django Pixel Lite](https://appseed.us/product/pixel-bootstrap/django/)

Django Web App generated by the AppSeed platform on top of [Pixel Lite](https://appseed.us/product/pixel-bootstrap/) design (free version) crafted by `Themesberg`.

> Version: **[v1.0.7](https://github.com/app-generator/django-pixel/releases)** - release date `2022-05-30` 
...
- 👉 Check-out the PREMIUM version, [Django Pixel PRO](https://django-pixel-pro.appseed-srv1.com/) (`live demo`) for more features and improved UI
  - ✅ `Bootstrap 5` version
